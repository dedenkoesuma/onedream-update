                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">  
                            <div class="inner-software-img software-img-shape">
                                <img src="{{ asset('img/images/ilustrasi.png') }}" alt="img" style="box-shadow:none;">
                            </div>
                        </div>
                        <div class="col-lg-6 pl-80">
                            <div class="section-title mb-30">
                                <h2>Kami Memproduksi Video Promosi / Profil yang Menarik & Informatif!</h2>
                            </div>
                            <div class="software-content inner-c-services-content">
                                <p>Video merupakan media yang paling efektif untuk melakukan campaign, awareness, dan edukasi pasar karena memadukan antara visual dengan audio, sehingga pesan yang disampaikan akan dengan mudah ditangkap oleh audience atau calon customer potensial Anda.</p>
                ...
                <div class="row justify-content-center">
                        <div class="col-xl-5 col-lg-7 col-md-9">
                            <div class="section-title text-center margin-md mb-35">
                                <span class="text-white">Tahapan Pembuatan Video</span>
                                <p >Setelah melakukan brainstorming tentang video yang akan dibuat, tim kami akan mulai berkolaborasi untuk memproduksi video yang menakjubkan.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 pb-5">
                    <div class="site-heading text-center">
                        <h1 class="h1">Pilihan Jenis Video</h1>
