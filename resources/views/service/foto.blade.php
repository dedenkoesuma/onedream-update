                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="inner-software-img software-img-shape">
                                <img src="{{ asset('img/images/ilustrasi2.png') }}" alt="img" style="box-shadow:none">
                            </div>
                        </div>
                        <div class="col-lg-6 pl-80">
                            <div class="section-title mb-30">
                                <h2>Kami Memproduksi Foto Promosi / Profil yang Menarik & Informatif!</h2>
                            </div>
                            <div class="software-content inner-c-services-content">
                                <p>Foto merupakan media yang paling efektif untuk melakukan campaign, awareness, dan edukasi pasar karena mampu menangkap momen secara visual, sehingga pesan yang disampaikan dapat dengan mudah ditangkap oleh audience atau calon customer potensial Anda.</p>
                ...
                <div class="row justify-content-center">
                        <div class="col-xl-5 col-lg-7 col-md-9">
                            <div class="section-title text-center margin-md mb-35">
                                <span class="text-white">Tahapan Pembuatan foto</span>
                                <p >Setelah melakukan brainstorming tentang foto yang akan dibuat, tim kami akan mulai berkolaborasi untuk memproduksi foto yang menakjubkan.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="single-counter text-center mb-50">
                                ...
                                <div class="counter-content">
                                    ...
                                    <p>Tim akan mulai membuat dan mengerjakan konsep foto secara profesional.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <div class="single-counter text-center mb-50">
                                ...
                                <div class="counter-content">
                                    ...
                                    <p>Dapatkan hasil foto dengan kualitas yang terbaik bersama kami.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2 pb-5">
                    <div class="site-heading text-center">
                        <h1 class="h1">Pilihan Jenis Foto</h1>
